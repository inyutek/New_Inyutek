            ...
            <div className="container mx-auto px-6 max-w-7xl">
                ...
                <ScrollReveal className="max-w-3xl mx-auto text-center mb-24">
                    <Reveal>
                        ...
                        <p className="type-lead-hero mx-auto max-w-2xl">
                            Real results and success stories from our partners.
                        </p>
                    </Reveal>
                </ScrollReveal>
                ...
                {posts.length === 0 && (
                    ...
                    >
                        ...
                        <h3 className="text-xl font-bold text-[#000024] mb-2">No case studies found</h3>
                        <p className="text-gray-500 max-w-md mx-auto">
                            Make sure your Notion database is connected and has published entries.
                        </p>
                    </motion.div>
                )}
            </div>
