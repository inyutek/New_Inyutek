...
export function ResultsSection() {
    return (
        <section className="bg-[#000024] py-24 md:py-32 text-white">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        {deliverables.map((item, i) => (
                            <Reveal key={i} delay={i * 0.1}>
                                <div className="flex items-center gap-4 bg-white/5 border border-white/10 p-5 rounded-xl hover:bg-white/10 transition-colors">
