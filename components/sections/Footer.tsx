                        ...
                        <div className="flex gap-4 mt-8">
                            {SOCIAL_LINKS.map((social) => (
                                <a
                                    ...
                                    className="w-10 h-10 flex items-center justify-center rounded-full bg-white shadow-sm border border-black/5 hover:-translate-y-1 hover:shadow-md transition-all duration-200"
